  ...
  return (
    <form ref={formRef} action={formAction} className="grid grid-cols-2 gap-4 rounded-lg border border-border bg-white p-5">
      <div className="col-span-2">
        ...
        <input name="title" required className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm" placeholder="Staff RN — Medical Surgical" />
      </div>
      <div>
      ...
      <div>
        ...
        <input name="location" required className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm" />
      </div>
      <div>
        <label className="text-sm font-medium text-ink">Salary min (optional)</label>
        <input name="salaryMin" type="number" step="1000" className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm" />
      </div>
      <div>
        <label className="text-sm font-medium text-ink">Salary max (optional)</label>
        <input name="salaryMax" type="number" step="1000" className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm" />
      </div>
      <div className="col-span-2">
        <label className="text-sm font-medium text-ink">Description (optional)</label>
        <textarea name="description" rows={3} className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm" />
      </div>
